...
// PINTU MASUK UTAMA (Tidak boleh terhapus)
export default function App() {
  ...
  if (!userName) {
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden">
          ...
          <header className="p-8"><h1 className="text-2xl font-bold flex items-center text-slate-800"><Home className="mr-2 text-blue-500" /> HomeBudget</h1></header>
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden pb-32">
          ...
          <header className="p-6 flex justify-between items-center max-w-6xl mx-auto w-full">
            <button onClick={() => setSelectedBudget(null)} className="text-xl font-bold flex items-center text-slate-800 hover:text-blue-600 transition">
              <Home className="mr-2 text-blue-500" /> HomeBudget
            </button>
  ...
  return (
      <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden">
        <Toaster position="top-right" />
        <header className="p-6 flex justify-between items-center max-w-6xl mx-auto w-full">
          <h1 className="text-2xl font-bold flex items-center text-slate-800"><Home className="mr-2 text-blue-500" /> HomeBudget</h1>
